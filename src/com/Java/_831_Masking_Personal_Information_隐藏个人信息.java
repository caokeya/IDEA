 ...
 */
public class _831_Masking_Personal_Information_隐藏个人信息 {
    class Solution {
        public String maskPII(String S) {
            if (S.contains("@")) {
                String l = S.toLowerCase();
                return l.substring(0, 1) + "*****" + l.charAt(l.indexOf("@") - 1) + l.substring(l.indexOf("@"));
            } else {
                ...
                if (len == 10) {
                    ...
                    return "+" + star + "-***-***-" + ph.substring(ph.length() - 4);
                }
